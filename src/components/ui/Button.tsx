    ...
    <button
      className={cn(
        'inline-flex items-center justify-center gap-2 font-semibold transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer',
        {
          ...
          'bg-[var(--color-surface)] text-[var(--color-primary)] border-[1.5px] border-[var(--color-primary)] rounded-full hover:bg-[var(--color-primary-subtle)]': variant === 'secondary',
          'bg-[var(--color-surface)] text-[var(--color-ink)] border border-[var(--color-hairline)] rounded-[10px] hover:bg-[var(--color-canvas)]': variant === 'utility',
